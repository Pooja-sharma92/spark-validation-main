...
import { ValidationJobDetailModal } from './ValidationJobDetailModal';
import {
  Search,
  RefreshCw,
  Loader2,
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-500">
          {jobs.length} executed job{jobs.length !== 1 ? 's' : ''}
          {error && (
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-3 py-1.5 text-sm border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors disabled:opacity-50"
        >
